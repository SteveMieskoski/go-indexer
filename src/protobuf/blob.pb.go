...
type BeaconHeaderResponse struct {
	...
	Data                []*BeaconHeaderResponse_Header `protobuf:"bytes,1,rep,name=Data,proto3" json:"Data,omitempty"`
...
func (x *BeaconHeaderResponse) GetData() []*BeaconHeaderResponse_Header {
	if x != nil {
		return x.Data
	}
	return nil
...
type BeaconHeaderResponse_Header struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BeaconHeaderResponse_Header) Reset() {
	*x = BeaconHeaderResponse_Header{}
	if protoimpl.UnsafeEnabled {
...
func (x *BeaconHeaderResponse_Header) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeaconHeaderResponse_Header) ProtoMessage() {}

func (x *BeaconHeaderResponse_Header) ProtoReflect() protoreflect.Message {
	mi := &file_blob_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeaconHeaderResponse_Header.ProtoReflect.Descriptor instead.
func (*BeaconHeaderResponse_Header) Descriptor() ([]byte, []int) {
	return file_blob_proto_rawDescGZIP(), []int{3, 0}
}

func (x *BeaconHeaderResponse_Header) GetHeader() *SignedBeaconBlockHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *BeaconHeaderResponse_Header) GetRoot() string {
	if x != nil {
		return x.Root
	}
	return ""
...
func (x *BeaconHeaderResponse_Header) GetCanonical() bool {
	if x != nil {
		return x.Canonical
	}
	return false
...
var file_blob_proto_rawDesc = []byte{
	...
	,
...
var file_blob_proto_goTypes = []interface{}{
	...
	(*BeaconHeaderResponse_Header)(nil), // 4: protobuf.BeaconHeaderResponse.Header
}
var file_blob_proto_depIdxs = []int32{
	...
	4, // 2: protobuf.BeaconHeaderResponse.Data:type_name -> protobuf.BeaconHeaderResponse.Header
	1, // 3: protobuf.BeaconHeaderResponse.Header.Header:type_name -> protobuf.SignedBeaconBlockHeader
...
func file_blob_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_blob_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeaconHeaderResponse_Header); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
